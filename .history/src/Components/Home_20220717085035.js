        ...
        <>
                            ...
                            <div className='col-md-3'>
                                <div className='card'>
                                    ...
                                    <p>ID :{state1[2]["Limited NCERT"][0].Package.name}</p>
                                    <p>ID :{state1[2]["Limited NCERT"][0].Exam.id}</p>
                                    <p>ID :{state1[2]["Limited NCERT"][0].Exam.type}</p>
                                    <p>ID :{state1[2]["Limited NCERT"][0].Exam.name}</p>
                                </div>
                                </div>
