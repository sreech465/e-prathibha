  ...
  return (
    <div style={{ display: "flex" }}>
      <div class="card">
        ...
        />
        <div class="card-body">
          A.3 years old Question paper civils services(Prelims) B.Limited UPSC
          Old question papers(CDS GEO scientists,CISF ,CAPF ,NDA,engineering
          services) C.Limited questions from basics of School
        </div>
      </div>
      <div class="card">
        <img
