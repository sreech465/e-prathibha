...
function CategoryOfExams() {
  ...
  return (
    ...
    >
      <div class="card" style={{ boxShadow: 100 }}>
        <img
        ...
        />
        <h2>EXPLORE FOR FREE</h2>
        <div class="card-body">
          A.3 years old Question paper civils services(Prelims)
          <br />
      ...
      <div class="card">
        ...
        />
        <div class="card-body">
          A.26 years old Question paper civils services(Prelims) <br />
          B.2014-2020 other UPSC Old question papers(CDS ,GEO
          scientists(Pre),CISF,CAPF,NDA,Engineering Services(Pre) and SO)
          C.Comprehensive basics of school NCERT (6th class to 10th class)
        </div>
      </div>
      <div class="card">
        <img
