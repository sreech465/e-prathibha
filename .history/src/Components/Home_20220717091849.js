        ...
        <>
                   ...
                   <div style={{display : 'flex'}}>
                            ...
                            <div className='col-md-3'>
                                ...
                                <div className='card'>
                                    <h2>Old question papers UPSC Civils (Pre)</h2>
                                    <p>ID :{state1[0]["Old question papers UPSC Civils (Pre)"][3].Package.id}</p>
                                    <p>NAME :{state1[0]["Old question papers UPSC Civils (Pre)"][3].Package.name}</p>
                                    <p>EXAM[ID] :{state1[0]["Old question papers UPSC Civils (Pre)"][3].Exam.id}</p>
                                    <p>EXAM[TYPE] :{state1[0]["Old question papers UPSC Civils (Pre)"][3].Exam.type}</p>
                                    <p>EXAM[NAME] :{state1[0]["Old question papers UPSC Civils (Pre)"][3].Exam.name}</p>
                                </div>
                                </div>
