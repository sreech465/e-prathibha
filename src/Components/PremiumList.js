...
const PremiumList = () => {
  ...
  const state77 = state7.exams[0]["26 Years Old"];
  console.log(state77, "arjun");
  return (
    // for(let i=0 ; i <  state7.exams[0]["26 Years Old"].length  ; i++){
      ...
      {state7 ? (
        <>
          <>
            ...
            <Link
              style={{ textDecoration: "none" }}
              to={`/PremiumList/${state7.exams[0]["26 Years Old"][6].Exam.id}`}
            >
              <div class="cards">
                <p style={{ color: "white", paddingLeft: "30px" }}>
                  {state7.exams[0]["26 Years Old"][6].Exam.name}
                </p>
                <p style={{ color: "white", paddingLeft: "30px" }}>PAPER 1</p>
              </div>
            </Link>
            <Link
              style={{ textDecoration: "none" }}
              to={`/PremiumList/${state7.exams[0]["26 Years Old"][7].Exam.id}`}
            >
              <div class="cards">
                <p style={{ color: "white", paddingLeft: "30px" }}>
                  {state7.exams[0]["26 Years Old"][7].Exam.name}
                </p>
                <p style={{ color: "white", paddingLeft: "30px" }}>PAPER 1</p>
              </div>
            </Link>
            <Link
              style={{ textDecoration: "none" }}
              to={`/PremiumList/${state7.exams[0]["26 Years Old"][8].Exam.id}`}
            >
              <div class="cards">
                <p style={{ color: "white", paddingLeft: "30px" }}>
                  {state7.exams[0]["26 Years Old"][8].Exam.name}
                </p>
                <p style={{ color: "white", paddingLeft: "30px" }}>PAPER 1</p>
              </div>
            </Link>
            <Link
              style={{ textDecoration: "none" }}
              to={`/PremiumList/${state7.exams[0]["26 Years Old"][9].Exam.id}`}
            >
              <div class="cards">
                <p style={{ color: "white", paddingLeft: "30px" }}>
                  {state7.exams[0]["26 Years Old"][9].Exam.name}
                </p>
                <p style={{ color: "white", paddingLeft: "30px" }}>PAPER 1</p>
              </div>
            </Link>
            <Link
              style={{ textDecoration: "none" }}
              to={`/PremiumList/${state7.exams[0]["26 Years Old"][10].Exam.id}`}
            >
              <div class="cards">
                <p style={{ color: "white", paddingLeft: "30px" }}>
                  {state7.exams[0]["26 Years Old"][10].Exam.name}
                </p>
                <p style={{ color: "white", paddingLeft: "30px" }}>PAPER 1</p>
              </div>
            </Link>
            <Link
              style={{ textDecoration: "none" }}
              to={`/PremiumList/${state7.exams[0]["26 Years Old"][11].Exam.id}`}
            >
              <div class="cards">
                <p style={{ color: "white", paddingLeft: "30px" }}>
                  {state7.exams[0]["26 Years Old"][12].Exam.name}
                </p>
                <p style={{ color: "white", paddingLeft: "30px" }}>PAPER 1</p>
              </div>
            </Link>
            <Link
              style={{ textDecoration: "none" }}
              to={`/PremiumList/${state7.exams[0]["26 Years Old"][13].Exam.id}`}
            >
              <div class="cards">
                <p style={{ color: "white", paddingLeft: "30px" }}>
                  {state7.exams[0]["26 Years Old"][13].Exam.name}
                </p>
                <p style={{ color: "white", paddingLeft: "30px" }}>PAPER 1</p>
              </div>
            </Link>
            <Link
              style={{ textDecoration: "none" }}
              to={`/PremiumList/${state7.exams[0]["26 Years Old"][14].Exam.id}`}
            >
              <div class="cards">
                <p style={{ color: "white", paddingLeft: "30px" }}>
                  {state7.exams[0]["26 Years Old"][14].Exam.name}
                </p>
                <p style={{ color: "white", paddingLeft: "30px" }}>PAPER 1</p>
              </div>
            </Link>
            <Link
              style={{ textDecoration: "none" }}
              to={`/PremiumList/${state7.exams[0]["26 Years Old"][15].Exam.id}`}
            >
              <div class="cards">
                <p style={{ color: "white", paddingLeft: "30px" }}>
                  {state7.exams[0]["26 Years Old"][15].Exam.name}
                </p>
                <p style={{ color: "white", paddingLeft: "30px" }}>PAPER 1</p>
              </div>
            </Link>
            <Link
              style={{ textDecoration: "none" }}
              to={`/PremiumList/${state7.exams[0]["26 Years Old"][16].Exam.id}`}
            >
              <div class="cards">
                <p style={{ color: "white", paddingLeft: "30px" }}>
                  {state7.exams[0]["26 Years Old"][16].Exam.name}
                </p>
                <p style={{ color: "white", paddingLeft: "30px" }}>PAPER 1</p>
              </div>
            </Link>
            <Link
              style={{ textDecoration: "none" }}
              to={`/PremiumList/${state7.exams[0]["26 Years Old"][17].Exam.id}`}
            >
              <div class="cards">
                <p style={{ color: "white", paddingLeft: "30px" }}>
                  {state7.exams[0]["26 Years Old"][17].Exam.name}
                </p>
                <p style={{ color: "white", paddingLeft: "30px" }}>PAPER 1</p>
              </div>
            </Link>
            <Link
              style={{ textDecoration: "none" }}
              to={`/PremiumList/${state7.exams[0]["26 Years Old"][18].Exam.id}`}
            >
              <div class="cards">
                <p style={{ color: "white", paddingLeft: "30px" }}>
                  {state7.exams[0]["26 Years Old"][18].Exam.name}
                </p>
                <p style={{ color: "white", paddingLeft: "30px" }}>PAPER 1</p>
              </div>
            </Link>
